...
class Backup:
    ...
    def main_process_checker(self):
        while True:
            ...
            try:
                ...
                print("")
                print("File not found at " + str(datetime.datetime.now())[11:19] + ", waitng for connection with the server to be restored...")
                time.sleep(60)
                print("")
                pass
                ...
                print("")
                print("Permission denied at " + str(datetime.datetime.now())[11:19] + ", waiting for access to be granted...")
                time.sleep(60)
                print("")
                pass
    ...
    def graphic_interface(self):
        ...
        backup = Button(c, text='ROZPOCZNIJ', font='calibri', border=5, command=lambda: [check_data(), self.main_process_checker()])
        backup.pack()
...
if granted:
    ...
    print("Access denied!")
    time.sleep(2)
    goodbye = input("Wciśnij ENTER żeby zakończyć")
